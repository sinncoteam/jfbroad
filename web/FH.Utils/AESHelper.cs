...
namespace JFB.Utils
{
    public class AESHelper
    {
        ...
        public static string Encode(string encryptString, string encryptKey)
        {
            ...
            rijndaelProvider.Key = ASCIIEncoding.ASCII.GetBytes(encryptKey);
            rijndaelProvider.IV = ASCIIEncoding.ASCII.GetBytes(KeysIV);
            ICryptoTransform rijndaelEncrypt = rijndaelProvider.CreateEncryptor();

            byte[] inputData = ASCIIEncoding.ASCII.GetBytes(encryptString);
        ...
        public static string Decode(string decryptString)
        {
            try
            {
                string decryptKey = "7b29e94b1b0bbaed";
                RijndaelManaged rijndaelProvider = new RijndaelManaged();
